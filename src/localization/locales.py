Locales = {
    ...
    "es-MX": {
        ...
        "config": {  # fix any grammar mistakes you can find
            ...
            "region": "región",
            "client_id": "client_id",
            "presence_refresh_interval": "intervalo_actualización_presencia",
            "locale": "localidad",
            "presences": "presencias",
            "menu": "menú",
        ...
        "prints": {
            "config_modification": {
                ...
                "config_saved": "¡configuración guardada! reinicie el programa para que los cambios surtan efecto.",
                "set_prompt": "establecer el valor de"
            },
            "startup": {
                "wait_for_rpc": "esperando al cliente rpc",
                "discord_not_detected": "¡discord no detectado! empezando el juego sin presencia...",
                "starting_valorant": "iniciando VALORANT",
            ...
            "errors": {
                "error_message": "el programa ha encontrado un error: por favor, cree un issue con el rastreo de abajo si este problema persiste",
